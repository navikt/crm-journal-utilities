...
export default class CRMThemeCategorization extends LightningElement {
    ...
    @api isCasePhone = false; // If Case is type='Phone' do not set auto focus on lightning-combobox. Set to true in NKS_Case_Log_a_Call Flow.
    ...
    hasRendered = false;
    renderedCallback() {
        if (this.hasRendered === false && !this.isCasePhone) {
